...
entity koa_mult_h1_mux_4dEe is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of koa_mult_h1_mux_4dEe is
    -- puts internal signals
    signal sel    : std_logic_vector(1 downto 0);
    -- level 1 signals
    signal mux_1_0    : std_logic_vector(320 downto 0);
    signal mux_1_1    : std_logic_vector(320 downto 0);
    -- level 2 signals
    signal mux_2_0    : std_logic_vector(320 downto 0);
begin
