...
// ==============================================================
#ifndef __koa_mult_h1_mul_6cud__HH__
#define __koa_mult_h1_mul_6cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(koa_mult_h1_mul_6cud) {
    ...
    SC_CTOR(koa_mult_h1_mul_6cud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
