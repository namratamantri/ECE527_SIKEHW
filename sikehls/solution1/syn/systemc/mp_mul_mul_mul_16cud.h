...
// ==============================================================
#ifndef __mp_mul_mul_mul_16cud__HH__
#define __mp_mul_mul_mul_16cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mp_mul_mul_mul_16cud) {
    ...
    SC_CTOR(mp_mul_mul_mul_16cud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
