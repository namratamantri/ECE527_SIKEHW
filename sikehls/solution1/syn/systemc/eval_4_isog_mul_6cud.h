...
// ==============================================================
#ifndef __eval_4_isog_mul_6cud__HH__
#define __eval_4_isog_mul_6cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(eval_4_isog_mul_6cud) {
    ...
    SC_CTOR(eval_4_isog_mul_6cud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
