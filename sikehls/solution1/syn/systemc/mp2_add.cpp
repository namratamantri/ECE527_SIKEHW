...
mp2_add::mp2_add(sc_module_name name) : sc_module(name), mVcdFile(0) {
    eval_4_isog_add_4fYi_U43 = new eval_4_isog_add_4fYi<1,2,448,448,448>("eval_4_isog_add_4fYi_U43");
    eval_4_isog_add_4fYi_U43->clk(ap_clk);
    eval_4_isog_add_4fYi_U43->reset(ap_rst);
    eval_4_isog_add_4fYi_U43->din0(b_0_V_read);
    eval_4_isog_add_4fYi_U43->din1(a_0_V_read);
    eval_4_isog_add_4fYi_U43->ce(ap_var_for_const0);
    eval_4_isog_add_4fYi_U43->dout(grp_fu_67_p2);
    eval_4_isog_add_4fYi_U44 = new eval_4_isog_add_4fYi<1,2,448,448,448>("eval_4_isog_add_4fYi_U44");
    eval_4_isog_add_4fYi_U44->clk(ap_clk);
    eval_4_isog_add_4fYi_U44->reset(ap_rst);
    eval_4_isog_add_4fYi_U44->din0(b_1_V_read);
    eval_4_isog_add_4fYi_U44->din1(a_1_V_read);
    eval_4_isog_add_4fYi_U44->ce(ap_var_for_const0);
    eval_4_isog_add_4fYi_U44->dout(grp_fu_74_p2);
...
mp2_add::~mp2_add() {
    ...
    delete eval_4_isog_add_4fYi_U43;
    delete eval_4_isog_add_4fYi_U44;
}
