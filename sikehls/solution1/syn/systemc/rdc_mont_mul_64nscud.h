...
// ==============================================================
#ifndef __rdc_mont_mul_64nscud__HH__
#define __rdc_mont_mul_64nscud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rdc_mont_mul_64nscud) {
    ...
    SC_CTOR(rdc_mont_mul_64nscud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
