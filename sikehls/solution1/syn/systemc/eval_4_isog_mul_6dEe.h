...
// ==============================================================
#ifndef __eval_4_isog_mul_6dEe__HH__
#define __eval_4_isog_mul_6dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(eval_4_isog_mul_6dEe) {
    ...
    SC_CTOR(eval_4_isog_mul_6dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
