...
// ==============================================================
#ifndef __xDBL_mul_64ns_64nbkb__HH__
#define __xDBL_mul_64ns_64nbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(xDBL_mul_64ns_64nbkb) {
    ...
    SC_CTOR(xDBL_mul_64ns_64nbkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
