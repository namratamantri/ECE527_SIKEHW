...
// ==============================================================
#ifndef __xDBL_mul_64s_64s_cud__HH__
#define __xDBL_mul_64s_64s_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(xDBL_mul_64s_64s_cud) {
    ...
    SC_CTOR(xDBL_mul_64s_64s_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
