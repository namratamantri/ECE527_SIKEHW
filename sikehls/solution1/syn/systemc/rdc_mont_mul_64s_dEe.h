...
// ==============================================================
#ifndef __rdc_mont_mul_64s_dEe__HH__
#define __rdc_mont_mul_64s_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rdc_mont_mul_64s_dEe) {
    ...
    SC_CTOR(rdc_mont_mul_64s_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
