...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_c_V \
    op interface \
    ports { c_V { O 896 vector } c_V_ap_vld { O 1 bit } } \
} "
}
